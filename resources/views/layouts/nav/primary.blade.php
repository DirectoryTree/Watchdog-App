<li class="nav-item">
    <a up-follow class="nav-link {{ request()->routeIs('watchers.show') || request()->routeIs('watchers.dogs.*') ? 'active' : '' }} d-flex align-items-center"
       href="{{ route('watchers.show', $watcher) }}">
        <i class="fas fa-tachometer-alt mr-1"></i> Dashboard
    </a>
</li>
<li class="nav-item">
    <a up-follow class="nav-link {{ request()->routeIs('watchers.objects.*') ? 'active' : '' }} d-flex align-items-center"
...
<li class="nav-item">
    <a up-follow class="nav-link {{ request()->routeIs('watchers.changes.*') ? 'active' : '' }} d-flex align-items-center"
...
<li class="nav-item">
    <a up-follow class="nav-link {{ request()->routeIs('watchers.scans.*') ? 'active' : '' }} d-flex align-items-center"
